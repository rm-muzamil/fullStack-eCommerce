...
<nav className='navbar'>
 ...
 <img className='icon' src="https://cdn-icons-png.flaticon.com/128/11107/11107521.png" alt="" />
 <img className='icon' src="https://cdn-icons-png.flaticon.com/128/428/428001.png" alt="" />
</nav>
</div>
...
<div className='product'>
 {
    ...
    <li className='items' key={product.id} >
      ...
      <button onClick={() => handelbuy(product.id)}className='buy' >View Detail</button>
      </div>
    </li>
  ))
